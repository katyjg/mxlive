...
\hfill {{ project.city|texsafe|cut:"None"|default:"available" }}, {{ project.province|texsafe|cut:"None"|default:"and must be" }}   {{ project.postal_code|texsafe|cut:"None"|default:"" }}\\
{\bf Username: }{{ project.name|texsafe|default:"" }} \hfill {{ project.country|texsafe|cut:"None"|default:"obtained manually." }} \\  
{\bf Password: }\underline{\hspace*{1.0in}} \hfill Phone: {{ project.contact_phone|texsafe|cut:"None"|default:"Not Listed" }} {% if project.contact_fax %}(Fax: {{ project.contact_fax|texsafe|default:"" }}){% endif %}\\ 
{% if project.account_number %}\hfill {\bf {% if project.carrier %}{{ project.carrier }} {% endif %}Account#: {{ project.account_number|texsafe|default:"" }} } \\{% endif %}
\end{center}{% endif %}
