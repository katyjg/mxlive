...
\begin{center}
	...
	{% for item in shipment.item_labels %}
		\parbox{\textwidth}{
		\begin{center}
    	{\color{blue!10!black!50!green} {\bf Item Label {{ forloop.counter }}: Affix this to the outside of the box containing item \\ "{{ item.name|texsafe|default:"" }}" to be shipped to the CLS. } }
    ...
    {% for dewar in shipment.dewar_set.all %}
    \newpage
    {\color{blue!50!black} {\bf Address Label {{ forloop.counter }}: Affix this to the outside of the dewar transport container \\ for dewar "{{ dewar.name|texsafe|default:"" }}" to be shipped to the CLS. }}
    \begin{center}
        \vspace{0.5in}
