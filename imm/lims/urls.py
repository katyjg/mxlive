...
urlpatterns = patterns('imm.lims.views',
    ...
    (r'^shipping/shipment/$', 'object_list', {'model': Shipment, 'template': 'lims/lists/shipping_list.html', 'can_add': True, 'can_upload': True}, 'lims-shipment-list'),
    ...
    (r'^shipping/shipment/(?P<id>\d+)/delete/$', 'delete_object', {'model': Shipment, 'redirect' : 'lims-shipment-list', 'orphan_models' : [(Dewar, 'shipment')]}, 'lims-shipment-delete'),
    (r'^shipping/shipment/(?P<id>\d+)/close/$', 'close_object', {'model' : Shipment, 'redirect' : 'lims-shipment-list'}, 'lims-shipment-close'),
    ...
    (r'^shipping/shipment/upload/$', 'upload_shipment', {'model': Shipment, 'form': ShipmentUploadForm, 'template': 'lims/forms/shipping_base.html'}, 'lims-shipment-upload'),
    #(r'^shipping/shipment/delete/(?P<id>\d+)/$', 'delete_shipment'),
    
    (r'^shipping/dewar/$', 'object_list', {'model': Dewar, 'template': 'lims/lists/shipping_list.html', 'can_add': True}, 'lims-dewar-list'),
    ...
    (r'^shipping/container/$', 'object_list', {'model': Container, 'template': 'lims/lists/shipping_list.html', 'can_add': True}, 'lims-container-list'),
    ...
    (r'^samples/crystal/$', 'object_list', {'model': Crystal, 'template': 'lims/lists/samples_list.html', 'can_add': True, 'can_prioritize': True}, 'lims-crystal-list'),
    ...
    (r'^samples/cocktail/$', 'object_list', {'model': Cocktail, 'template': 'lims/lists/samples_list.html', 'can_add': True}, 'lims-cocktail-list'),
    ...
    (r'^samples/crystalform/$', 'object_list', {'model': CrystalForm, 'template': 'lims/lists/samples_list.html', 'can_add': True}, 'lims-crystalform-list'),
    ...
    (r'^samples/constituent/$', 'object_list', {'model': Constituent, 'template': 'lims/lists/samples_list.html', 'can_add': True}, 'lims-constituent-list'),
    ...
    (r'^experiment/request/$', 'object_list', {'model': Experiment, 'template': 'lims/lists/experiment_list.html', 'can_add': True, 'can_prioritize': True}, 'lims-experiment-list'),
    ...
    (r'^experiment/result/$', 'object_list', {'model': Result, 'template': 'lims/lists/experiment_list.html'}, 'lims-result-list'),
    (r'^experiment/result/(?P<id>\d+)/$', 'object_detail', {'model': Result, 'template': 'lims/entries/result.html'} , 'lims-result-detail'),

    (r'^experiment/dataset/$', 'object_list', {'model': Data, 'template': 'lims/lists/experiment_list.html'}, 'lims-dataset-list'),
    (r'^experiment/dataset/(?P<id>\d+)/$', 'object_detail', {'model': Data, 'template': 'lims/entries/experiment.html'} , 'lims-dataset-detail'),

    (r'^experiment/strategy/$', 'object_list', {'model': Strategy, 'template': 'lims/lists/experiment_list.html'}, 'lims-strategy-list'),
    ...
    (r'^experiment/result/resubmit/$','create_object', {'model': Experiment, 'form': ExperimentFromStrategyForm, 'template': 'lims/forms/experiment_base.html', 'action': 'resubmit', 'redirect': 'lims-experiment-list'}, 'lims-strategy-experiment-new'),        
