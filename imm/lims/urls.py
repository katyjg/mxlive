...
urlpatterns = patterns('imm.lims.views',
    ...
    (r'^shipping/shipment/(?P<id>\d+)/widget/(?P<src_id>\d+)/dewar/(?P<dest_id>\d+)/container/(?P<obj_id>\d+)/$', 'add_existing_object', {'destination':Shipment, 'object':Container}, 'lims-shipment-add-container'),
    #####################
    ...
    (r'^shipping/dewar/(?P<dest_id>\d+)/widget/(?P<src_id>\d+)/none/0/container/(?P<obj_id>\d+)/$', 'add_existing_object', {'destination':Dewar, 'object':Container, 'reverse':True}, 'lims-dewar-add-container'),
    #########################
    ...
    (r'^shipping/container/(?P<dest_id>\d+)/widget/(?P<src_id>\d+)/crystal/(?P<obj_id>\d+)/$', 'add_existing_object', {'destination':Container, 'object':Crystal, 'reverse':True}, 'lims-container-add-crystal'),
    #######################
    ...
    #CRYSTALS##############
    (r'^samples/crystal/$', 'object_list', {'model': Crystal, 'template': 'objlist/generic_list.html', 'can_add': True, 'can_prioritize': True, 'is_individual': True}, 'lims-crystal-list'),
    ...
    #REQUESTS##############
    (r'^experiment/request/$', 'object_list', {'model': Experiment, 'template': 'objlist/generic_list.html', 'can_add': True, 'can_prioritize': True, 'is_individual': True}, 'lims-experiment-list'),
    ...
    ######################
    #REPORTS##############
    (r'^experiment/report/$', 'object_list', {'model': Result, 'template': 'objlist/generic_list.html'}, 'lims-result-list'),
