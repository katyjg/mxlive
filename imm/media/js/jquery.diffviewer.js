(function($){
    ...
    $.diffviewer = function(e,o)
    {
        ...
        */
        ...
        mousemove(function(e){return me.update_pos(e)}).
        ...
        // bind document mousemove and mousemove instead of img ones
        $(document).mousemove(function(e){return me.drag(e)}).
        mouseup(function(e){return me.drag_end(e)});
        
        //init overview object
        this.overview_img = $("<img>").
    ...
    $iv.fn.extend({
        ...
        loadImage: function(src)
        {
            ...
            this.img_object.object.unbind('load').
                ...
                load(function(){
                    ...
                    if(!me.container.hasClass("diffviewer_cursor")){
        ...
        **/
        setCoords: function(x,y)
        {
            ...
            ow = 126 * this.settings.width/this.img_object.display_width;
            oh = 126 * this.settings.height/this.img_object.display_height;
        ...
        **/
        ...
        update_status: function()
        {
            ...
            if (percent > this.settings.zoom_min + 10) {
        ...
        **/
        ...
        /**
        *  callback for clicking within overview
        **/
        thumb_click: function(e)
        {
            var x, y, offsets =  this.overview_img.offset();
            x = (e.pageX - offsets.left) * this.img_object.display_width/128 - this.settings.width/2;
            y = (e.pageY - offsets.top) * this.img_object.display_height/128- this.settings.height/2;
            this.setCoords(-x,-y);
            return false;
        },
        ...
        **/
        update_pos: function(e)
        {
			...
			z=this.settings.resFunc.call(this, Math.sqrt(x*x+y*y));
			z=z.toFixed(2);
        ...
        /**
        *   create buttons info box
        **/
        createui: function()
        {
            var me=this; 
            
            $("<div>").addClass("diffviewer_zoom_in").addClass("diffviewer_common").
            addClass("diffviewer_button").
            mousedown(function(){me.zoom_by(1); return false;}).appendTo(this.container);
            
            $("<div>").addClass("diffviewer_zoom_out").addClass("diffviewer_common").
            addClass("diffviewer_button").
            mousedown(function(){me.zoom_by(- 1); return false;}).appendTo(this.container);
                        
            $("<div>").addClass("diffviewer_zoom_fit").addClass("diffviewer_common").
            addClass("diffviewer_button").
