...
(function () {
  d3.timeline = function() {
    ...
    function timeline (gParent) {
        ...
        d.forEach( function(datum, index){
          ...
          g.selectAll("svg").data(data).enter()
            ...
            .attr("width", function (d, i) {
              return Math.max((d.ending_time - d.starting_time) * scaleFactor, 1);
            })
            .attr("cy", function(d, i) {
                return d.y || getStackPosition(d, i) - itemHeight/2;
            })
            .attr("cx", getXPos)
            .attr("r", itemHeight / 2)
            .attr("height", itemHeight)
      ...
      var gSize = g['_groups'][0][0].firstChild.getBoundingClientRect();
      setHeight();
      ...
      function setHeight() {
        if (!height && !gParentItem.attr("height")) {
          if (itemHeight) {
            ...
            d3.select(gParent['_groups'][0].firstChild).attr("height", height);
          } else {
