...
class IntegerationTests(DjangoTestCase):
    ...
    def home(self, client):
        ...
        self.assert_location(response, '/users/')
    ...
    def upload_shipment(self, client): 
        ...
        response = client.post('/users/shipping/shipment/upload/', {'project': '1', 'excel':excel})
        self.assertEqual(302, response.status_code)
    ...
    def send_shipment(self, client):
        ...
        response = client.post('/users/shipping/shipment/1/send/', {'project': '1', 'carrier': '1', 'tracking_code': '1'})
        self.assertEqual(200, response.status_code)
