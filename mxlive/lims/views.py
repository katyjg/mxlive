...
from mxlive.download.views import create_download_key, create_cache_dir, send_raw_file
...
def project_required(function):
    """ Decorator that enforces the existence of a mxlive.lims.models.Project """
...
def project_assurance(function):
    """ Decorator that creates a default mxlive.lims.models.Project if there isn't one """
