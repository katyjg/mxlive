...
urlpatterns = [
    ...
    url(r'^profile/(?P<username>[\w\-]+)/statistics/$', views.ProjectStatistics.as_view(), name='project-statistics'),
    ...
    url(r'^shipments/(?P<pk>\d+)/data/$', views.ShipmentDataList.as_view(), name='shipment-data'),
    url(r'^shipments/(?P<pk>\d+)/reports/$', views.ShipmentReportList.as_view(), name='shipment-reports'),
    ...
    url(r'^sessions/(?P<pk>\d+)/data/$', views.SessionDataList.as_view(), name='session-data'),
    url(r'^sessions/(?P<pk>\d+)/reports/$', views.SessionReportList.as_view(), name='session-reports'),
